...
class Item(models.Model): #additional information requied on an M8 part 
    ...
    item_code            = models.CharField(max_length = 65, blank= True)
    description          = models.CharField(max_length = 120, default = '')
    purchase_price        = models.DecimalField(max_digits = 6, decimal_places=2, default= 0.00)
    lastModified         = models.DateTimeField(auto_now=True)
    sells_for            = models.DecimalField(max_digits = 6, decimal_places=2, default= 0.00)
...
class LineItem(models.Model):
    ...
    multiplier           = models.DecimalField(max_digits = 3, decimal_places = 2, default= 1.522) #if multiplier set to 0 allow fixed price to stay multiplier only on quotes 
    sell_price           = models.DecimalField(max_digits = 6, decimal_places = 2, default= 0.00)
...
class Quote(models.Model):
    ...
    total                = models.DecimalField(max_digits=6, decimal_places=2, default= 0.00) #if fixed price we need this
...
class POLine(LineItem):
    ...
    purchase_price        = models.DecimalField(max_digits = 6, decimal_places=2, default= 0.00) #final price we pay should be recorded
